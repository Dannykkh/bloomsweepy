...
const englishMessages = {
  "메뉴 막대": "Menu bar",
  "패널 열기": "Open panel",
  "메모리 사용량 표시": "Show memory usage",
  "창을 닫아도 메뉴 막대에서 상태를 확인하고 다시 열 수 있습니다.": "Check status and reopen the app from the menu bar after closing the window.",
  "아이콘 옆의 메모리 사용률만 숨기거나 표시합니다. 아이콘은 계속 남습니다.": "Show or hide only the memory percentage beside the icon. The icon remains visible.",
  "CPU·메모리·시스템 디스크만 10초마다 확인하며 파일을 검사하지 않습니다.": "Checks CPU, memory, and the system disk every 10 seconds without scanning files.",
  "완전히 종료하려면 메뉴 막대 패널의 종료 또는 ⌘Q를 사용하세요.": "To fully quit, use Quit in the menu bar panel or ⌘Q.",
  "메뉴 막대 설정 적용 중…": "Applying menu bar settings…",
  "메뉴 막대를 준비하지 못했습니다. 앱을 다시 실행해 주세요.": "The menu bar could not be prepared. Restart the app.",
  "메뉴 막대 설정을 확인하지 못했습니다. 다시 확인해 주세요.": "Could not read menu bar settings. Check again.",
  "작업": "Actions",
  "설치된 앱 {{count}}개를 확인했습니다.": "Found {{count}} installed apps.",
  "앱 목록을 불러오지 못했습니다: {{detail}}": "Could not load apps: {{detail}}",
  "파일 탐색기에 위치를 표시했습니다.": "Revealed the location in the file manager.",
  "위치를 표시하지 못했습니다: {{detail}}": "Could not reveal the location: {{detail}}",
  "Windows 제거 화면을 열었습니다. 앱을 직접 선택해 제거한 뒤 목록을 새로 고치세요. 제거 완료를 확인한 것은 아닙니다.": "Opened Windows uninstall settings. Select and uninstall the app there, then refresh this list. Removal has not been verified.",
  "제거 화면을 열지 못했습니다: {{detail}}": "Could not open uninstall settings: {{detail}}",
  "앱을 확인하고, 운영체제에 맞는 제거 절차로 정리합니다.": "Review apps and use the removal process for your operating system.",
  "정식 제거 절차를 우선 사용하세요.": "Use the official uninstall process first.",
  "Windows에서는 설치된 앱 설정에서 제거합니다. 앱 폴더나 AppData를 추측해 삭제하지 않습니다.": "On Windows, uninstall through Installed apps settings. App folders and AppData are not deleted by guesswork.",
  "전용 제거 프로그램이 있으면 먼저 사용하세요. 일반 Mac 앱만 본체를 휴지통으로 옮기며, 설정과 문서는 자동 삭제하지 않습니다.": "Use a dedicated uninstaller when available. Only ordinary Mac app bundles are moved to Trash; settings and documents are not deleted automatically.",
  "목록은 설치 정보만 조회합니다. 앱 전체 용량과 아이콘을 미리 읽지 않습니다.": "The list reads installation metadata only, without scanning every app's size or loading its icons.",
  "Windows 제거 화면 열기": "Open Windows uninstall settings",
  "앱 이름·제작사·경로 검색": "Search app name, publisher, or path",
  "결과를 확인하지 못했습니다. 휴지통과 작업 기록을 먼저 확인한 뒤 목록을 새로 고치세요. 같은 요청을 자동으로 재시도하지 않습니다.": "The result is unconfirmed. Check Trash and the action history before refreshing. The request will not be retried automatically.",
  "설치 정보를 불러오는 중입니다.": "Loading installation information.",
  "이 운영체제에서는 앱 관리 기능을 지원하지 않습니다.": "App management is not supported on this operating system.",
  "표시할 앱이 없습니다. 검색어나 목록을 확인하세요.": "No apps to display. Check your search or refresh the list.",
  "버전 {{version}}": "Version {{version}}",
  "버전 미확인": "Version unknown",
  "설치 위치 미확인": "Install location unknown",
  "용량 미측정": "Size not measured",
  "{{name}} 위치 표시": "Reveal {{name}}",
  "앱 본체 이동 완료": "App bundle moved",
  "{{name}} 앱 본체 정리 검토": "Review removal of {{name}}",
  "앱 본체 정리 검토": "Review app bundle removal",
  "앱 목록 페이지": "App list pages",
  "이전": "Previous",
  "{{current}} / {{total}} 페이지": "Page {{current}} of {{total}}",
  "다음": "Next",
  "일부 설치 정보를 확인하지 못했습니다.": "Some installation information could not be read.",
  "{{name}}의 관련 데이터 검토": "Review data related to {{name}}",
  "앱 본체와 별개입니다. 정확한 앱 식별자로 연결된 캐시·환경설정만 후보이며, 필요할 수 있으므로 직접 선택하세요.": "This is separate from the app bundle. Only caches and preferences matched by exact app identifier are candidates. They may still be needed; select them yourself.",
  "문서·공유 데이터·Application Support·Containers는 이 목록에 포함하지 않습니다.": "Documents, shared data, Application Support, and Containers are excluded.",
  "현재 확인된 관련 데이터 후보가 없습니다. 모든 잔여 데이터가 없다는 뜻은 아닙니다.": "No related data candidates were found. This does not mean all leftover data is gone.",
  "선택 {{count}}개": "{{count}} selected",
  "선택 데이터 정리 검토": "Review selected data cleanup",
  "데이터 유지하고 닫기": "Keep data and close",
  "환경설정": "Preferences",
  "검토를 준비하지 못했습니다: {{detail}}": "Could not prepare the review: {{detail}}",
  "결과를 확인하지 못했습니다. 휴지통과 작업 기록을 확인하세요: {{detail}}": "The result is unconfirmed. Check Trash and action history: {{detail}}",
  "이 앱 본체만 휴지통으로 옮깁니다. 설정·문서·별도 서비스는 제거하지 않습니다. 전용 제거 프로그램이 필요한 앱은 먼저 정식 제거 절차를 사용하세요.": "Only this app bundle will move to Trash. Settings, documents, and separate services remain. If the app requires a dedicated uninstaller, use its official removal process first.",
  "아래에서 확인한 데이터만 휴지통으로 옮깁니다. 환경설정이 초기화될 수 있으며, 사용자 문서나 다른 앱의 공유 데이터는 선택하면 안 됩니다.": "Only the data reviewed below will move to Trash. Preferences may reset. Do not select documents or data shared with other apps.",
  "대상과 실행 중 여부를 확인하고 있습니다.": "Checking the target and whether it is running.",
  "이 앱에 전용 제거 프로그램이 필요하지 않음을 확인했습니다.": "I confirmed that this app does not require a dedicated uninstaller.",
  "표시한 앱 본체만 이동하며, 설정과 문서는 남겨 둠을 확인했습니다.": "I understand that only the displayed app bundle will move; settings and documents remain.",
  "선택 데이터의 경로와 영향을 확인했으며, 해당 데이터만 이동합니다.": "I reviewed the selected paths and impact; only this data will move.",
  "휴지통 이동을 처리하고 있습니다. 완료할 때까지 기다려 주세요.": "Moving to Trash. Please wait until it finishes.",
  "창을 닫으면 관련 데이터를 별도로 검토할 수 있습니다. 자동 선택하거나 삭제하지 않습니다.": "Close this dialog to review related data separately. Nothing is selected or deleted automatically.",
  "앱 본체만 휴지통으로 이동": "Move app bundle only to Trash",
  "선택 데이터만 휴지통으로 이동": "Move selected data only to Trash",
  "{{name}} 열기를 운영체제에 요청했습니다.": "Asked the operating system to open {{name}}.",
  "{{name}}은 직접 열지 않고 파일 탐색기에서 위치만 표시했습니다.": "Revealed {{name}} in the file manager without opening it.",
  "{{name}} 열기 요청을 완료하지 못했습니다: {{detail}}": "Could not complete the request to open {{name}}: {{detail}}",
  "{{name}} 열기": "Open {{name}}",
  "문서·미디어는 기본 앱으로, 일반 폴더는 파일 탐색기로 엽니다. 프로그램과 링크는 위치만 표시합니다.": "Documents and media open in their default app; ordinary folders open in the file manager. Programs and links are only revealed.",
  "폴더 열기": "Open folder",
  "열기": "Open",
  "앱 제거와 관련 데이터 정리를 나누어 검토합니다.": "Review app removal and related data cleanup separately.",
  "앱 본체 휴지통 이동": "Move app bundle to Trash",
  "앱 관련 데이터 정리": "Clean up related app data",
  "운영체제 휴지통 비우기": "Empty system Trash",
  "휴지통 열기": "Open Trash",
  "복원할 수 없는 작업": "Irreversible action",
  "휴지통 전체 영구 삭제": "Permanently empty all Trash",
  "별도 확인 후 영구 삭제합니다.": "Permanently deletes after separate confirmation.",
  "휴지통 비우기는 macOS와 Windows에서 지원합니다.": "Empty Trash is supported on macOS and Windows.",
  "휴지통 이동만으로는 디스크 공간이 확보되지 않을 수 있습니다.": "Moving items to Trash may not free disk space.",
  "현재 사용자의 연결된 드라이브 휴지통 전체가 대상입니다. 다른 앱에서 버린 항목도 포함되며, 선택한 폴더나 BroomSweepy 작업 기록으로 범위를 제한하지 않습니다.": "This affects the current user's system Trash across connected drives, including items discarded by other apps. It is not limited to the selected folder or BroomSweepy's action history.",
  "실행 시점에 휴지통에 있는 항목을 영구 삭제합니다. 이 앱에서 되돌릴 수 없으며, 작업 기록으로도 복원할 수 없습니다.": "Items in Trash at execution time are permanently deleted. This app cannot undo it, and action history cannot restore them.",
  "먼저 휴지통을 열어 보관할 항목을 복원하세요. 내용과 용량을 미리 전부 스캔하지 않습니다. 확인은 2분 동안 한 번만 사용할 수 있습니다.": "Open Trash first and restore anything you want to keep. Contents and sizes are not fully scanned beforehand. This confirmation is valid once for 2 minutes.",
  "다른 앱의 항목까지 영구 삭제되며 되돌릴 수 없음을 확인했습니다.": "I understand that items from other apps are also permanently deleted and this cannot be undone.",
  "운영체제 응답을 기다리는 중입니다. OS 확인창을 확인하세요. 시작된 삭제는 이 앱에서 취소할 수 없습니다.": "Waiting for the operating system. Check its confirmation dialog. This app cannot cancel deletion after it starts.",
  "운영체제에 비우기를 요청했습니다. 휴지통에서 완료 여부와 남은 항목을 확인하세요. 확보된 용량은 보장하지 않습니다.": "Requested the OS to empty Trash. Check Trash for completion and remaining items. Freed space is not guaranteed.",
  "운영체제에서 취소되었습니다. 일부 항목은 이미 삭제됐을 수 있으니 휴지통을 확인하세요.": "Cancelled by the operating system. Some items may already have been deleted; check Trash.",
  "운영체제가 권한을 거부했습니다. macOS에서는 시스템 설정 → 개인정보 보호 및 보안 → 자동화에서 Finder 권한을 확인하세요. 권한을 자동 변경하지 않습니다.": "Permission was denied by the OS. On macOS, check Finder access in System Settings → Privacy & Security → Automation. Permissions are not changed automatically.",
  "운영체제 휴지통 기능을 시작하지 못했습니다. 휴지통을 직접 열어 확인하세요.": "Could not start the OS Trash action. Open Trash directly to check.",
  "완료 여부를 확인하지 못했습니다. 운영체제 작업은 계속될 수 있습니다. 휴지통을 직접 확인하세요. 중복 삭제 요청을 막기 위해 앱을 다시 시작하기 전에는 재요청할 수 없습니다.": "Completion could not be confirmed; the OS may still be working. Check Trash directly. To prevent duplicate requests, this app will not send another request until restarted.",
  "작업을 시작할 수 없습니다. 진행 중인 작업과 시스템 자원을 확인한 뒤 다시 검토하세요.": "Cannot start the action. Check running tasks and system resources, then review again.",
  "휴지통을 열지 못했습니다. 운영체제에서 직접 열어 확인하세요.": "Could not open Trash. Open it directly from the operating system.",
  "휴지통 비우기는 예외적으로 휴지통 전체를 영구 삭제하며 별도 확인 뒤에만 실행합니다.": "Empty Trash is an exception: it permanently deletes the entire system Trash after separate confirmation.",
  "폴더 휴지통 이동": "Move folder to Trash",
  "확인 시간이 만료됐습니다. 창을 닫고 다시 검토하세요.": "This confirmation expired. Close the dialog and review again.",
  "폴더와 하위 항목 전체를 이동합니다. 숨김 파일·앱·프로젝트도 포함되며, 일부 항목만 남길 수 없습니다. 이 확인은 5분 동안 한 번만 사용할 수 있습니다.": "The entire folder and its contents will move, including hidden files, apps, and projects. You cannot keep individual items in this operation. This confirmation is valid once for 5 minutes.",
  "파일 {{files}}개 · 폴더 {{folders}}개(선택 폴더 포함) · 내용은 전송하지 않고 메타데이터로 변경을 확인합니다.": "{{files}} files · {{folders}} folders (including the selected folder) · Contents are not transmitted; changes are checked using metadata.",
  "포함 항목과 변경 여부를 확인하고 있습니다. 검토가 끝나기 전에는 이동할 수 없습니다.": "Checking the contents and metadata for changes. Moving is disabled until the review is ready.",
  "숨김 파일·앱·프로젝트를 포함한 하위 항목 전체가 함께 이동함을 확인했습니다.": "I understand that all contents, including hidden files, apps, and projects, will move together.",
  "빈 폴더 검토": "Review empty folders",
  "휴지통 이동 최종 확인": "Final confirmation: move to Trash",
  "발견 {{found}}개 · 검토 가능 {{available}}개 · 선택 {{selected}}개": "Found {{found}} · Reviewable {{available}} · Selected {{selected}}",
  "빈 폴더도 앱이나 프로젝트에 필요할 수 있습니다. 아래 경로를 확인하고 보관할 폴더는 제외하세요.": "Empty folders may still be needed by apps or projects. Check the paths and exclude folders you want to keep.",
  "보호·변경·검사 상한으로 {{count}}개는 검토 목록에서 제외됐습니다. 전체를 삭제하는 작업이 아닙니다.": "{{count}} items were omitted due to protection, changes, or scan limits. This does not remove every empty folder.",
  "읽지 못한 항목이 있어 검사 결과가 완전하지 않을 수 있습니다.": "Some items could not be read, so the scan may be incomplete.",
  "모두 선택": "Select all",
  "선택 해제": "Clear selection",
  "검토할 빈 폴더가 없습니다.": "No empty folders are available for review.",
  "확인 시간이 만료됐습니다. 선택을 다시 검토하세요.": "This confirmation expired. Review your selection again.",
  "이 목록만 휴지통으로 이동합니다. 실행 직전 다시 검사하며, 변경된 항목이 있으면 중단합니다.": "Only this list will move to Trash. Items are rechecked immediately before each move; a changed item stops the operation.",
  "파일 내용은 읽지 않습니다. 빈 폴더 정리는 큰 용량 확보를 보장하지 않습니다.": "File contents are not read. Empty-folder cleanup does not guarantee significant space savings.",
  "선택 다시 검토": "Review selection again",
  "확인한 {{count}}개 휴지통으로 이동": "Move {{count}} reviewed items to Trash",
  "선택한 폴더 최종 검토": "Review selected folders",
  "휴지통 이동 결과": "Trash move results",
  "요청 {{requested}}개 중 {{moved}}개를 휴지통으로 이동했습니다.": "Moved {{moved}} of {{requested}} requested items to Trash.",
  "작업 기록 저장이 완전하지 않습니다. 실제 휴지통과 작업 기록을 확인하세요.": "The action journal is incomplete. Check the system Trash and local action history.",
  "항목별 결과 보기": "View per-item results",
  "이동 완료": "Moved",
  "필요하면 운영체제 휴지통에서 복원을 시도할 수 있습니다. 추가 정리 전 다시 검사하세요.": "You can try restoring items from the system Trash if needed. Scan again before further cleanup.",
  "추가 정리 전 빈 폴더를 다시 검사하세요.": "Scan for empty folders again before further cleanup.",
  "앱 검사를 완료했습니다. 빈 폴더 {{count}}개를 검토할 수 있습니다.": "The app finished scanning. {{count}} empty folders are available for review.",
  "후보 선택을 변경했습니다. 현재 {{count}}개가 선택되어 있습니다.": "Updated the review selection. {{count}} items are now selected.",
  "후보 페이지를 갱신했습니다. 아래 카드에서 전체 검토 가능 목록을 확인하세요.": "Updated the candidate page. The card below shows the full reviewable list.",
  "아직 휴지통으로 이동한 항목은 없습니다.": "Nothing has been moved to Trash yet.",
  "앱에서 후보 확인 또는 휴지통 이동을 처리하고 있습니다.": "The app is reviewing candidates or processing the Trash move.",
  "작업 중단": "Stop operation",
  "파일 검사는 로컬에서 처리합니다. {{provider}}에는 제한된 이름·크기·후보 요약과 질문·대화 기록이 전달됩니다. 직접 입력한 경로나 내용도 포함될 수 있습니다.": "Files are scanned locally. {{provider}} receives bounded name, size and candidate summaries plus your questions and chat history, including any paths or contents you type.",
  "빈 폴더 정리": "Empty-folder cleanup",
