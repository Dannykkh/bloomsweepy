...
- **view** `FileOrganizerView` : View (L2)

## BroomSweepy/Views/FilesCategoryView.swift
- **view** `FilesCategoryView` : View (L2)
- **enum** `Tab` : String, CaseIterable, Identifiable (L6)
...
- **view** `MemoryStatCard` : View (L247)

## BroomSweepy/Views/NextStepCard.swift
- **view** `MiniNextButton` : View (L4)
- **view** `NextStepCard` : View (L28)
- **view** `NextStepsSection` : View (L83)

## BroomSweepy/Views/OnboardingView.swift
- **view** `OnboardingView` : View (L2)

## BroomSweepy/Views/PerformanceView.swift
- **view** `PerformanceView` : View (L3)
- **enum** `SortOption` : String, CaseIterable (L9)
- **struct** `RunningAppInfo` : Identifiable (L207)

## BroomSweepy/Views/PermissionManagerView.swift
- **view** `PermissionManagerView` : View (L3)
...
- **view** `RuleRow` : View (L82)
- **view** `RuleEditorSheet` : View (L140)

## BroomSweepy/Views/SecurityCategoryView.swift
- **view** `SecurityCategoryView` : View (L2)
- **enum** `Tab` : String, CaseIterable, Identifiable (L6)

## BroomSweepy/Views/SettingsView.swift
- **view** `SettingsView` : View (L2)
...
- **view** `SpeedCategoryView` : View (L2)
- **enum** `Tab` : String, CaseIterable, Identifiable (L6)
...
- **view** `MonitorStatItem` : View (L231)
