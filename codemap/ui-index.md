...
- **component** `IndexMetric` (L521) — `apps/desktop/src/views/DocumentSearchView.tsx:521`

## apps/desktop/src/views/DuplicatesView.tsx
- **component** `DuplicatesView` (L35) — `apps/desktop/src/views/DuplicatesView.tsx:35`

## apps/desktop/src/views/FastFileSearchView.tsx
- **component** `IndexMetric` (L557) — `apps/desktop/src/views/FastFileSearchView.tsx:557`
...
- **view** `ContentView` : View (L80) — `BroomSweepy/ContentView.swift:80`
...
- **view** `FileOrganizerView` : View (L2) — `BroomSweepy/Views/FileOrganizerView.swift:2`

## BroomSweepy/Views/FilesCategoryView.swift
- **view** `FilesCategoryView` : View (L2) — `BroomSweepy/Views/FilesCategoryView.swift:2`
...
- **view** `MemoryStatCard` : View (L247) — `BroomSweepy/Views/MemoryCleanerView.swift:247`

## BroomSweepy/Views/NextStepCard.swift
- **view** `MiniNextButton` : View (L4) — `BroomSweepy/Views/NextStepCard.swift:4`
- **view** `NextStepCard` : View (L28) — `BroomSweepy/Views/NextStepCard.swift:28`
- **view** `NextStepsSection` : View (L83) — `BroomSweepy/Views/NextStepCard.swift:83`

## BroomSweepy/Views/OnboardingView.swift
- **view** `OnboardingView` : View (L2) — `BroomSweepy/Views/OnboardingView.swift:2`

## BroomSweepy/Views/PerformanceView.swift
- **view** `PerformanceView` : View (L3) — `BroomSweepy/Views/PerformanceView.swift:3`

## BroomSweepy/Views/PermissionManagerView.swift
- **view** `PermissionManagerView` : View (L3) — `BroomSweepy/Views/PermissionManagerView.swift:3`

## BroomSweepy/Views/PrivacyCategoryView.swift
...
- **view** `RuleRow` : View (L82) — `BroomSweepy/Views/RuleBuilderView.swift:82`
- **view** `RuleEditorSheet` : View (L140) — `BroomSweepy/Views/RuleBuilderView.swift:140`

## BroomSweepy/Views/SecurityCategoryView.swift
- **view** `SecurityCategoryView` : View (L2) — `BroomSweepy/Views/SecurityCategoryView.swift:2`

## BroomSweepy/Views/SettingsView.swift
- **view** `SettingsView` : View (L2) — `BroomSweepy/Views/SettingsView.swift:2`
...
- **view** `SpaceCategoryView` : View (L2) — `BroomSweepy/Views/SpaceCategoryView.swift:2`

## BroomSweepy/Views/SpeedCategoryView.swift
- **view** `SpeedCategoryView` : View (L2) — `BroomSweepy/Views/SpeedCategoryView.swift:2`
...
- **view** `MonitorStatItem` : View (L231) — `BroomSweepy/Views/SystemMonitorView.swift:231`
